...
class DatasetAdapter(object):
    ...
    # 20211005 tamura add adj
    valid_field_name = (
        'src', 'tgt', 'indices', 'src_map', 'src_ex_vocab', 'adj', 'alignment',
        'align')
    # 20211005 tamura end
    ...
    def _process(item, is_train):
        ...
        # 20211005 tamura
        if 'adj' in maybe_example:
            maybe_example['adj'] = ' '.join(maybe_example['adj'])
        # 20211005 tamura end
...
class ParallelCorpus(object):
    ...
    def __init__(self, name, src, tgt, adj, align=None):    # 20211005 tamura
    ...
    def load(self, offset=0, stride=1):
        ...
        with exfile_open(self.src, mode='rb') as fs,\
                ...
                exfile_open(self.adj, mode='rb') as fadj,\
                exfile_open(self.align, mode='rb') as fa:
            logger.info(f"Loading {repr(self)}...")
            for i, (sline, tline, adj, align) in enumerate(zip(fs, ft, fadj, fa)):
                if (i % stride) == offset:
    ...
    def __repr__(self):
        ...
        return '{}({}, {}, {}, align={})'.format(
            cls_name, self.src, self.tgt, self.adj, self.align)
# 20211005 tamura end
    ...
    if is_train:
        ...
        if CorpusName.VALID in opts.data.keys():
            corpora_dict[CorpusName.VALID] = ParallelCorpus(
                ...
                # 20211005 tamura
                opts.data[CorpusName.VALID]["path_adj"],
                # 20211005 tamura end
